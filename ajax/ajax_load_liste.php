...
//culcul url dossier
  ...
  $items[$i][5] = '<a href="/admin/action/renvoiMail/' . $ligne['email'] . '"><i class="fas fa-reply-all"></i></a>&nbsp;&nbsp;<a href="/admin/action/unsetPartage/' . $ligne['id'] . '"><i class="fas fa-trash-alt" style="color:red;"></i></a>';
  $i++;
}
